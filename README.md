...
4. Implement this device using 30 solenoids in total creating 5 braille cells (eqivalent to transmitting 5 characters at once)

## Main Components
1. Arduino Uno R3
2. 12 V Power Supply
3. N-Channel MOSFET 60V 30A
4. Push-Pull Solenoids
5. 1N4001 Rectifier Diodes - 1A 50V
